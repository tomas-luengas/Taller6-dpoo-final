...
{
    /**
     * La etiqueta donde se dibuja el mapa y se hacen las senales de los restaurantes
     */
    private JLabel labMapa;

    /**
     * La lista de restaurantes que se estan dibujando en el mapa
     */
    ...
    public void paint( Graphics g )
    {
        ...
        for( Restaurante r : restaurantes )
        {
            int x = r.getX( );
            int y = r.getY( );
            g2d.setColor( r.isVisitado( ) ? Color.RED : Color.BLUE );
    ...
    /**
     * Actualiza la lista de restaurantes y llama al metodo repaint() para que se actualice el mapa
